...
public class GeneRNAInformationTO {
    ...
    private List<GeneRNAInformationResultTO> results = null;
    ...
    @JsonProperty("results")
    public List<GeneRNAInformationResultTO> getResults() {
        return results;
    }

    @JsonProperty("results")
    public void setResults(List<GeneRNAInformationResultTO> results) {
